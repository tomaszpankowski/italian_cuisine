...
class Footer extends Component{
    render(){
        return(
            <footer>
                <Container fluid className="d-flex align-items-center bg-dark text-danger pt-3 opacity-9 border-top border-danger">
                        ...
                        <Col xs={12} md={6} lg={7} className="text-center text-md-end">                    
                            <ul className="list-inline">
                                <li className="list-inline-item">
                                    <Link to="#">
                                        <span className="fa fa-facebook text-danger"></span>
                                    </Link>
                                </li>
                                <li className="list-inline-item">
                                    <Link to="#">
                                        <span className="fa fa-instagram text-danger"></span>
                                    </Link>
                                </li>
                                <li className="list-inline-item">
                                    <Link to="#">
                                        <span className="fa fa-twitter text-danger"></span>
                                    </Link>
                                </li>
                            </ul>       
                        </Col>
